...
TEST_F(BinnedDatasetTest, VSRooNLLVar)
{
   ...
   // manually create NLL, ripping all relevant parts from RooAbsPdf::createNLL, except here we also set binnedL = true; this is necessary, because the RooNLLVar ctor doesn't create a binned likelihood otherwise
   RooArgSet projDeps;
